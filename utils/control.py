...
class Control:
    ...
    def inject_coarse_and_plot_image(
        self, styles, class_index, coarse_inject_latent,coarse_inject_class_list,coords=None, plot=True, get_image=True,coarse_inject_layer=0
            ):
            image, seg = generate (
                self.model,
                styles[0].unsqueeze(0),
    ...
    def edit_image_inject_coarse(
        ...
        return self.inject_coarse_and_plot_image(
            styles, class_index, plot=plot, get_image=get_image,coarse_inject_latent= styles_copy
            ,coarse_inject_class_list= [class_index], coarse_inject_layer= coarse_inject_layer
        )
