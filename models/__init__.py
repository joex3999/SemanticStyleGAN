...
def make_model(args, verbose=True):
    ...
    model = SemanticGenerator(
        ...
        local_channel=args.local_channel,
        base_layers=args.base_layers,
        depth_layers=args.depth_layers,
        coarse_size=args.coarse_size,
        coarse_channel=args.coarse_channel,
        min_feat_size=args.min_feat_size,
        residual_refine=args.residual_refine,
        detach_texture=args.detach_texture,
