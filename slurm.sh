...
#SBATCH --output=./log_files/SSG_v3.14/SSG%j.%N_output.out
#SBATCH --error=./log_files/SSG_v3.14/SSG%j.%N_error.out
#SBATCH --qos=batch
...
#CUDA_VISIBLE_DEVICES=0,1,2,3 python3.9 -m torch.distributed.launch --nproc_per_node=4 train.py --dataset /no_backups/g013/data/lmdb_datasets/lmdb_v3.3 --inception /no_backups/g013/data/inception_models/inception_v3.3.pkl --save_every 5000 --checkpoint_dir /no_backups/g013/checkpoints/SSG_v3.13  --seg_dim 16 --size 256  --residual_refine 
#Using 1 GPU
python3.9 train.py --dataset /no_backups/g013/data/lmdb_datasets/lmdb_v3.3 --inception /no_backups/g013/data/inception_models/inception_v3.3.pkl --save_every 5000 --checkpoint_dir /no_backups/g013/checkpoints/SSG_v3.14  --seg_dim 16 --size 256  --residual_refine 
